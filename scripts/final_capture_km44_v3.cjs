...
async function main() {
    ...
    try {
        ...
        console.log('--- INICIANDO CAPTURA MANUAL KM 44 (Turno PM) ---');
        ...
        const insertLectura = await client.query(`
            ...
            RETURNING id;
        `, [puntoId, fecha, hora, escalaArr, escalaAbj, radial, 'ADMIN_MANUAL', 'Captura de cierre de día 15/Marzo - 23:30', 'pm', 'CIC-001']);
